...
G                D                    C                     G
 Del que ya sólo sales,  para decirme vale; déjame quarenta duros.
       C                G                    Bm                     Am
(g a b)  Ya no te tengo miedo nena,  pero no puedo,  seguirte en tu viaje.
        C                  G                      Bm
(a b c)   ¿Cuantas veces hubiera dado,  la vida entera;
               F                       D      D
...
G             C                                D     D
 Ahora es demasiado tarde                 princesa.
                (ahora es demasiado tarde princesa)
     G               C                                   D     D
Búscate a otro perro; que te ladre                  princesa.      No ves que
                    (buscate otro pero que te ladre princesa)
G             C                                 D     D
 Ahora es demasiado tarde                  princesa.
                 (ahora es demasiado tarde princesa)
...
G               D                      C                        G
 Como no ibas a verte  envuelta en una muerte,  con asalto a farmacia.
         C                  G                       Bm                     Am
(g a b )  ¿Con que ley condenarte,  si somos juez y parte,  todos de tus andanzas?
        C                G                     Bm
...
[Outro]
G             C                                D     D
 Ahora es demasiado tarde  (do not stop)  princesa.
                (ahora es demasiado tarde princesa)
     G               C                                   D     D
Búscate a otro perro; que te ladre                  princesa.      No ves que
                    (buscate otro pero que te ladre princesa)
G             C                                 D     D
 Ahora es demasiado tarde                  princesa.
                 (ahora es demasiado tarde princesa)
     G               C                                   D    D
Búscate a otro perro; que te ladre                  princesa. No ves! No ves! No ves que!
                    (buscate otro pero que te ladre princesa)
G             C                                 D     D
 Ahora es demasiado tarde                  princesa.
                 (ahora es demasiado tarde princesa)
